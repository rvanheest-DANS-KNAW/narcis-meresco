...
# AddProvenanceToMetaPart(dateformat="%Y-%m-%dT%H:%M:%SZ", fromKwarg='lxmlNode'),

class AddProvenanceToMetaPartTest(SeecrTestCase):

    def setUp(self):        
        SeecrTestCase.setUp(self)
        self.harvestdate = AddProvenanceToMetaPart(dateformat="%Y-%m-%dT%H:%M:%SZ", fromKwarg='lxmlNode')
