...
#         print "DD body:", etree.tostring(response)
    ...
    def testModsToLong(self):
        ...
        self.assertEqual(None, testNamespaces.xpathFirst(response, '//long:metadata/long:grantAgreements/long:grantAgreement/long:funderIdentifier/text()'))
        ...
        self.assertEqual('e136', testNamespaces.xpathFirst(response, '//long:metadata/long:relatedItem[@type="host"]/long:part/long:articleNumber/text()'))
        ...
        self.assertEqual('<i>Spektator</i><i>, 8</i>(5):e136, 209 - 228. Oxford: Blackwell Publishers. ISSN 00286666.', testNamespaces.xpathFirst(response, '//long:metadata/long:hostCitation/text()'))
    ...
    def testDataciteToLong(self):
        ...
        self.assertEqual('501100000780', testNamespaces.xpathFirst(response, '//long:metadata/long:grantAgreements//long:grantAgreement/long:funderIdentifier/text()'))
        self.assertEqual('info:eu-repo/grantAgreement/EC/FP7/608166', testNamespaces.xpathFirst(response, '//long:metadata/long:grantAgreements/long:grantAgreement/long:code/text()'))
        self.assertEqual('Andorra', testNamespaces.xpathFirst(response, '//long:metadata/long:grantAgreements//long:grantAgreement[2]/long:funder/text()'))
        ...
        self.assertEqual('info:eu-repo/grantAgreement/NWO//2300182466/', testNamespaces.xpathFirst(response, '//long:metadata/long:grantAgreements/long:grantAgreement[6]/long:code/text()'))
        self.assertEqual('nl', testNamespaces.xpathFirst(response, '//long:metadata/long:language/text()'))
