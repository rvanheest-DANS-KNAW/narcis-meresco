...
class ApiTest(IntegrationTestCase):
    ...
    def testDcToLong(self):
        ...
        self.assertEqual('Search', testNamespaces.xpathFirst(response, '//long:metadata/long:subject/long:topic/text()'))
    ...
    def testDidlDcToLong(self):
        ...
        self.assertEqual('Precipitation', testNamespaces.xpathFirst(response, '//long:metadata/long:subject/long:topic/text()'))
    ...
    def testModsToLong(self):
        ...
        self.assertEqual('This is the subject', testNamespaces.xpathFirst(response, '//long:metadata/long:subject/long:topic/text()'))
    ...
    def testMods3xToLong(self):
        ...
        self.assertEqual('freight', testNamespaces.xpathFirst(response, '//long:metadata/long:subject[not(@xml:lang)]/long:topic/text()'))
        self.assertEqual('In english please.', testNamespaces.xpathFirst(response, '//long:metadata/long:subject[@xml:lang="en"]/long:topic/text()'))
    ...
    def testDataciteToLong(self):
        ...
        self.assertEqual('Archaeology', testNamespaces.xpathFirst(response, '//long:metadata/long:subject/long:topic/text()'))
        self.assertEqual('OPGRAVING', testNamespaces.xpathFirst(response, '//long:metadata/long:subject[@xml:lang="en"]/long:topic/text()'))
        ...
        self.assertEqual(3, len(testNamespaces.xpath(response, '//long:metadata/long:subject[not(@xml:lang)]/long:topic')))
