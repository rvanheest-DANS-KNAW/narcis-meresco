...
class ApiTest(IntegrationTestCase):
    ...
    def testDataciteToLong(self):
        ...
        self.assertEqual('Archaeology', testNamespaces.xpathFirst(response, '//long:metadata/long:subject[not(@xml:lang)]/long:topic/text()'))
        self.assertEqual('OPGRAVING', testNamespaces.xpathFirst(response, '//long:metadata/long:subject[@xml:lang="en"]/long:topic/text()'))
        self.assertEqual('ABR-periode', testNamespaces.xpathFirst(response, '//long:metadata/long:subject[not(@xml:lang)]/long:topic/long:subjectScheme/text()'))
        self.assertEqual('ABR-periode-label', testNamespaces.xpathFirst(response, '//long:metadata/long:subject[@xml:lang="en"]/long:topic/long:subjectScheme/text()'))
        ...
        self.assertEqual(3, len(testNamespaces.xpath(response, '//long:metadata/long:geoLocations/long:geoLocation')))
