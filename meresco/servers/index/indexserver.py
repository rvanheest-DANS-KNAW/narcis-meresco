...
from meresco.dans.recordpid2authornid import RecordPidToAuthNid
...
untokenizedFieldnames = [f.name for f in drilldownFields] + [
    untokenizedFieldname('oai_id'),
    untokenizedFieldname('fundingid'),
    untokenizedFieldname('dare_id'),
    untokenizedFieldname('publicationid'),
    ...
    untokenizedFieldname('nids_aut_enriched'),
]
